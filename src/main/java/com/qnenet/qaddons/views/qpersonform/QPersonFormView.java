package com.qnenet.qaddons.views.qpersonform;
...
@PageTitle("QPersonForm")
@Route(value = "person-form", layout = MainLayout.class)
public class QPersonFormView extends Composite<VerticalLayout> {

    public QPersonFormView() {
